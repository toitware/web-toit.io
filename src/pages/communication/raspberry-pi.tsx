    ...
    >
      ...
      <Layout title="Raspberry Pi" simplified callToAction={<JoinTheBetaButton size="small" />}>
        <Section
          ...
          `}
        >
          <SideBySide illustration={microcontrollerSvg} illustrationWidth={540} illustrationHeight={407}>
        ...
        >
          <SideBySide
            ...
            illustrationWidth={666}
            illustrationHeight={429}
          >
        ...
        <Section css={darkSection}>
          <CenteredBlock
            css={css`
              --centeredBlockWidth: ${clampBuilder("tiny", "huge", 30, 41)};
            `}
          >
            <h1>Dedicated IoT platform for Raspberry Pi</h1>
            <p css={bigFont}>
          ...
          <ContentSpacer />
          <SideBySide illustration={codeSampleSvg} illustrationWidth={555} illustrationHeight={536}>
