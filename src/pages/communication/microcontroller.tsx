...
export function IndexPage(): JSX.Element {
  return (
    <Layout simplified>
      ...
      >
        <PageTitle
          title={<span>Toit - High-level programming platform on ESP32 microcontrollers</span>}
          css={css`
      ...
      >
        <ParagraphHeader title="Fast and safe" subtitle="Modular applications for embedded devices">
          ...
          execute them efficiently. Fast and easy coding on the ESP32 microcontroller.
        </ParagraphHeader>
      ...
      <Section>
        <SideBySide illustration={KeysSvg}>
          ...
          <p>Deploy code, access logs, update firmware, and collect data from your microcontrollers.</p>
        </SideBySide>
        <ContentSpacer />
        <SideBySide
          illustration={
...
/> */}
        ...
        <SideBySide illustration={ControlCenterSvg}>
          ...
          <p>
            ...
            integrate our platform into your products and make your microcontrollers fully programmable.
          </p>
        </SideBySide>
      </Section>
    </Layout>
