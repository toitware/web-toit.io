...
and Toit provides powerful API endpoints such that you data can flow from your devices into your own IoT cloud system.
...
The applications running on your devices can communicate with each other either directly, if they run on the same device, or via the Toit cloudm
...
Then, provision your hardware, thereby installing the latest released Toit firmware and setup WiFi connections.

Your hardware will be linked to your Toit account and your are ready to run or deploy Toit code on your hardware.
...
If your connection to your hardware is unstable, the update will eventually succeed, so you dont need to worry about that part. 

The same is applicable to Toit application updates on your devices.
