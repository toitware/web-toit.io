---
title: Toit Terms of Service
path: /terms-of-service
date: 2021-01-26
---

import { whiteBlueTheme } from "../components/theme";
import { Grid } from "@material-ui/core";

<HorizontalBlock theme={whiteBlueTheme} last>
<HorizontalBlockItem single>

## Toit Terms of Service
...
These Terms of Use for Toit (the "Terms") set forth the terms and conditions for the subscription to the Toit Platform which the legal entity set out in the order form which is not Us ("You" or "Your") has purchased and governs how You may access and make use of the Toit Platform.
