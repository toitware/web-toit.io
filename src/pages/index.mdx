---
path: /
title: Continuous firmware delivery
date: 2021-01-20
---
...
import espressifSvg from "../assets/images/espressif.svg";
...
<img class="graphic" src={cloudSvg} />
...
integration (most of us use Visual Studio Code) that includes syntax
highlighting, goto-definitions, and auto completions among other things.
...
<Block centered theme={whiteBlueTheme}>

Official Espressif platform partner

<br />
<a
  href="https://www.espressif.com/en/ecosystem/third-party-resources/third-party-platforms"
  target="_blank"
  rel="noreferrer"
>
  <img class="graphic" src={espressifSvg} />
</a>
