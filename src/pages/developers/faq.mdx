...
- **The Toit Language** - Work in a modern, high-level progamming language, which has been open sourced together with the Toit compiler,
  virtual machine, and standard libraries.
...
If you need help or have questions regarding drivers, don't hesitate to ask us either using the public [Slack channel](https://chat.toit.io)
...
The Toit language has been open sourced and is available via [GitHub](https://github.com/toitlang/toit).
