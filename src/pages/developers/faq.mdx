---
title: FAQ for Toit developers
description: Find the answers to the most common Toit questions about our platform, firmware and open-source programming language.
path: /company/faq
date: 2021-04-06
---
...
- **The Toit Language** - Work in an open source, high-level programming language with all the
...
Toit provides a [GRPC API](https://docs.toit.io/apis) for communicating with the Toit console from your client application.
We have [example implementations](https://github.com/toitware/api) for Java, Python, Dart, C#, Golang, and NodeJS, that shows how to allow a client
application to do all public operations on the Toit console.

Toit also offers high-level APIs for system metrics and logs, that are optimized for size.

</FaqEntry>
<FaqEntry question="How fast can I get started using Toit on my hardware?">

There are only a [few steps](https://docs.toit.io/getstarted) required to get started with Toit. First, you need a Toit account.
...
The [documentation](https://docs.toit.io/peripherals/drivers/sparkfun_joystick) contains a tutorial on how to write new drivers.
Furthermore, the list of already published drivers can be viewed [here](https://docs.toit.io/peripherals/drivers/driverslist).
These are often a good starting point for writing your own driver.

If you need help or have questions regarding drivers, don't hesitate to ask us either using [Discord](https://discord.gg/Q7Y9VQ5nh2), our
[GitHub forum](https://github.com/toitlang/toit/discussions), or by writing to developers@toit.io.

</FaqEntry>
<FaqEntry question="Which types of connectivity does Toit offer?">

The ESP32 and Toit offer out-of-the-box WiFi and [BLE](https://docs.toit.io/tutorials/ble) connectivity. It is also possible
...
The Toit language is open source and is available via [GitHub](https://github.com/toitlang/toit).
