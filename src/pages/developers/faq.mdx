...
<FaqGroup title="" activeColor={ goldenSecondary.string() }>
...
We support all available ESP32 hardware models, but we will only use up to 4 MB of flash.
...
<FaqEntry question="Which types of connectivity do Toit offer?">
