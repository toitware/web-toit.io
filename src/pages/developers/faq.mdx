...
With Toit, you get build-in access to IoT procotols such as I2C and SPI, as well as GPIO support, which makes it possible to write drivers directly in the Toit language.
...
There are only a few steps required to get started wiht Toit. First, you need a Toit account.
...
<FaqEntry question="How fast is over-the-air firmware updates of my devices?">
...
At the moment, we are prototyping with ethernet connectivity, which soon will be an option as well.
...
With Toit, you use only one language for all the logic on your devices, whether it
